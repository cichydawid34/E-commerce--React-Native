...
export default function MainHeader() {
  ...
  React.useEffect(() => {
    ...
    if (value != null) {
      setRetEvents(events.filter((e) => e.type == value));
      console.warn(JSON.stringify(retEvents));
      console.error(retEvents);
    }
  }, [value]);
            ...
            return (
              ...
              >
                ...
                <View style={styles.stripedInformations}>
                  <Text style={styles.stripeDate}>12 December 2012</Text>
